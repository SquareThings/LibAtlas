...
function InputForm() {
    ...
    // Create a request body object with user inputs
        ...
        const handleLinkClick = (event) => {
            ...
            fetch('http://127.0.0.1:8000/dob/violations/', {
            method: 'POST',
            headers: {
            'Content-Type': 'application/json',
            },
    ...
    return (
        <div>
            ...
            {apiResponse.body && typeof apiResponse === 'object' ? (
                <ul>
                    <li  className='violationText'> <a href={"http://127.0.0.1:8000/dob/"+apiResponse.body.Violations_Link} onClick={handleLinkClick}>Total Number of OATH/ECB Violations</a>: {apiResponse.body.Violations_Total}</li>
