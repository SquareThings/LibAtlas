...
function NYC() {
    return (
        <div>
            ...
            <iframe class="embedMap" src="https://ssompal1.github.io/LiberationAtlasMap/public/index" title="NYC Map of Prostitution and Massage Arrests" style={{ marginTop: "8%" }}></iframe>
