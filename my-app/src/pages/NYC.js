...
function NYC() {
    return (
        <div>
            ...
            <div className="mapTextContainer"><p className="mapText">
            ...
            <iframe class="embedMap" src="https://squarethings.github.io/NYCMap/" title="NYC Map of Prostitution and Massage Arrests"></iframe>
        </div >
    );
}
